...
const properties = {
  ...
  email:{type: STRING.type, required: true , unique: true , lowercase: true, match: emailRegex},
...
export default async( req, res, next) => {
  return schemaEnforcer({req: req, res: res, next: next, modelProperties: properties, Model: User});
}